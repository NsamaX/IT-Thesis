...
class GameLabelWidget extends StatelessWidget {
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: imagePath != null
            ...
            : const Icon(Icons.inbox_rounded, color: Colors.black, size: 24.0),
      ),
    );
  }
  ...
  String _extractDescription(String description) => description.contains('//') ? description.split('//')[1] : description;
}
