...
class DatabaseService {
  ...
  /*----------------------------------------------------------------------------
   ...
   |
   |  วัตถุประสงค์:
   |      คืนค่า Database ที่ใช้ในแอป หากยังไม่มีการเปิดใช้งานจะทำการโหลดฐานข้อมูล
   |
   |  ค่าที่คืนกลับ:
   |      - Future<Database> ที่เปิดใช้งานเรียบร้อยแล้ว
   *--------------------------------------------------------------------------*/
  ...
  /*----------------------------------------------------------------------------
   |  ฟังก์ชัน _initDatabase
   |
   |  วัตถุประสงค์:
   |      เปิดใช้งานฐานข้อมูล SQLite และตั้งค่าพื้นฐาน
   |
   |  ค่าที่คืนกลับ:
   |      - Future<Database> ที่เปิดใช้งานเรียบร้อยแล้ว
   *--------------------------------------------------------------------------*/
  ...
  /*----------------------------------------------------------------------------
   |  ฟังก์ชัน _createTables
   |
   |  วัตถุประสงค์:
   |      สร้าง Table ทั้งหมดที่ใช้ในแอปเมื่อ Database ถูกสร้างครั้งแรก
   |
   |  พารามิเตอร์:
   |      db (IN) -- Instance ของ Database ที่ใช้ execute คำสั่ง SQL
   |      version (IN) -- เวอร์ชันของ Database
   *--------------------------------------------------------------------------*/
  ...
  /*----------------------------------------------------------------------------
   ...
   |
   |  วัตถุประสงค์:
   |      อัปเกรด Database โดยไม่ลบข้อมูลเก่า
   |
   |  พารามิเตอร์:
   |      db (IN) -- Instance ของ Database ที่ใช้ execute คำสั่ง SQL
   |      oldVersion (IN) -- เวอร์ชันเก่าของ Database
   |      newVersion (IN) -- เวอร์ชันใหม่ของ Database
   *--------------------------------------------------------------------------*/
  ...
  /*----------------------------------------------------------------------------
  |  ฟังก์ชัน _configureDatabase
  |
  |  วัตถุประสงค์:
  |      ตั้งค่าพิเศษสำหรับ Database เพื่อเพิ่มประสิทธิภาพการทำงาน
  |
  |  พารามิเตอร์:
  |      db (IN) -- Instance ของ Database ที่ใช้ execute คำสั่ง SQL
  *---------------------------------------------------------------------------*/
  ...
  /*----------------------------------------------------------------------------
   |  ฟังก์ชัน printTables
   |
   |  วัตถุประสงค์:
   |      ตรวจสอบและแสดงรายชื่อ Tables ทั้งหมดใน Database
   *--------------------------------------------------------------------------*/
